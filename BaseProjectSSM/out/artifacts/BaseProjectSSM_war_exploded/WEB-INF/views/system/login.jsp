...
<div id="particles-js">
		<div class="login" style="display: block;">
			...
			<%--<div class="login-center clearfix">--%>
				...
				<%--<div class="login-center-input">--%>
					<%--<input style="width:50%;" type="text" name="cpacha" id="cpacha" value="" placeholder="请输入验证码" onfocus="this.placeholder= &#39 &#39;" onblur="this.placeholder= &#39;请输入验证码&#39;">--%>
	...
	function removeClass(ele, cls) {
	  if (hasClass(ele, cls)) {
		...
		document.querySelector(".login-button").onclick = function(){
				...
				$.ajax({
					url:'login',
					data:{username:username,password:password},             //data:{username:username,password:password,cpacha:cpacha},
					type:'post',
					dataType:'json',
